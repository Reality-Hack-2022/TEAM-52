...
public class Record3DStream : MonoBehaviour
{
    ...
    //Saul test'
    public Texture2D saulpositionTex;
    public Texture2D saulcolorTex;


    public void saulTestWithDummyParticles()
    {
        if (saulpositionTex != null && saulcolorTex != null)
        {
            int numParticles = saulpositionTex.width * saulpositionTex.height;
