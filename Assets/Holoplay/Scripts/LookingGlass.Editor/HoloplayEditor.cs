...
namespace LookingGlass.Editor {
    ...
    public class HoloplayEditor : UnityEditor.Editor {
        ...
        private void OnEnable() {
            ...
            serializedObject.FindProperty(nameof(Holoplay.cameraData)).isExpanded = true;
        ...
        private bool CustomGUI(Holoplay hp, SerializedProperty property) {
