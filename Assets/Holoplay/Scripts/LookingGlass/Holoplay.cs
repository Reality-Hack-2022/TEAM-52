...
namespace LookingGlass {
    ...
    public partial class Holoplay : MonoBehaviour, ISerializationCallbackReceiver {
        ...
        [Space(20)]
        [Tooltip("Contains camera fields used in rendering each of the single views that correspond to Unity camera properties, with some extra Holoplay-specific fields.")]
        [SerializeField] internal HoloplayCameraData cameraData = new HoloplayCameraData();

        [SerializeField] internal HoloplayGizmos gizmos = new HoloplayGizmos();
        [SerializeField] internal HoloplayEvents events = new HoloplayEvents();
        [SerializeField] internal HoloplayOptimizationData optimization;
        [SerializeField] internal HoloplayDebugging debugging = new HoloplayDebugging();

        //NOTE: This applies to all of the fields below that now use:
        //      - CameraData
        //      - Gizmos
        //      - Events
        //      - Optimization
        ...
        [HideInInspector, Obsolete("Use Holoplay.CameraData instead."), SerializeField] private CameraClearFlags obsolete_ClearFlags = CameraClearFlags.Color;
        [FormerlySerializedAs("background")]
        [HideInInspector, Obsolete("Use Holoplay.CameraData instead."), SerializeField] private Color obsolete_Background = Color.black;
        [FormerlySerializedAs("cullingMask")]
        [HideInInspector, Obsolete("Use Holoplay.CameraData instead."), SerializeField] private LayerMask obsolete_CullingMask = -1;
        [Range(5, 90)]
        [FormerlySerializedAs("fov")]
        [HideInInspector, Obsolete("Use Holoplay.CameraData instead."), SerializeField] private float obsolete_FieldOfView = 14;
        [FormerlySerializedAs("depth")]
        [HideInInspector, Obsolete("Use Holoplay.CameraData instead."), SerializeField] private float obsolete_Depth = 0;
        [FormerlySerializedAs("renderingPath")]
        [HideInInspector, Obsolete("Use Holoplay.CameraData instead."), SerializeField] private RenderingPath obsolete_RenderingPath = RenderingPath.UsePlayerSettings;
        [FormerlySerializedAs("occlusionCulling")]
        [HideInInspector, Obsolete("Use Holoplay.CameraData instead."), SerializeField] private bool obsolete_OcclusionCulling = true;
        [FormerlySerializedAs("allowHDR")]
        [HideInInspector, Obsolete("Use Holoplay.CameraData instead."), SerializeField] private bool obsolete_AllowHDR = true;
        [FormerlySerializedAs("allowMSAA")]
        [HideInInspector, Obsolete("Use Holoplay.CameraData instead."), SerializeField] private bool obsolete_AllowMSAA = true;
#if UNITY_2017_3_OR_NEWER
        [FormerlySerializedAs("allowDynamicResolution")]
        [HideInInspector, Obsolete("Use Holoplay.CameraData instead."), SerializeField] private bool obsolete_AllowDynamicResolution = false;
#endif

        [FormerlySerializedAs("frustumColor")]
        [HideInInspector, Obsolete("Use Holoplay.Gizmos instead."), SerializeField] private Color obsolete_FrustumColor = new Color32(0, 255, 0, 255);
        [FormerlySerializedAs("middlePlaneColor")]
        [HideInInspector, Obsolete("Use Holoplay.Gizmos instead."), SerializeField] private Color obsolete_MiddlePlaneColor = new Color32(150, 50, 255, 255);
        [FormerlySerializedAs("handleColor")]
        [HideInInspector, Obsolete("Use Holoplay.Gizmos instead."), SerializeField] private Color obsolete_HandleColor = new Color32(75, 100, 255, 255);
        [FormerlySerializedAs("drawHandles")]
        [HideInInspector, Obsolete("Use Holoplay.Gizmos instead."), SerializeField] private bool obsolete_DrawHandles = true;

        [FormerlySerializedAs("size")]
        [HideInInspector, Obsolete("Use Holoplay.CameraData instead."), SerializeField] private float obsolete_Size = 5;
        [Range(0.01f, 5)]
        [FormerlySerializedAs("nearClipFactor")]
        [HideInInspector, Obsolete("Use Holoplay.CameraData instead."), SerializeField] private float obsolete_NearClipFactor = HoloplayDevice.GetSettings(HoloplayDevice.Type.Portrait).nearClip;
        [Range(0.01f, 40)]
        [FormerlySerializedAs("farClipFactor")]
        [HideInInspector, Obsolete("Use Holoplay.CameraData instead."), SerializeField] private float obsolete_FarClipFactor = 4;
        [FormerlySerializedAs("scaleFollowsSize")]
        [HideInInspector, Obsolete("Use Holoplay.CameraData instead."), SerializeField] private bool obsolete_ScaleFollowsSize;
        [Range(0, 1)]
        [FormerlySerializedAs("viewconeModifier")]
        [HideInInspector, Obsolete("Use Holoplay.CameraData instead."), SerializeField] private float obsolete_ViewconeModifier = 1;
        [Range(0, 1)]
        [FormerlySerializedAs("centerOffset")]
        [HideInInspector, Obsolete("Use Holoplay.CameraData instead."), SerializeField] private float obsolete_CenterOffset;
        [Range(-90, 90)]
        [FormerlySerializedAs("horizontalFrustumOffset")]
        [HideInInspector, Obsolete("Use Holoplay.CameraData instead."), SerializeField] private float obsolete_HorizontalFrustumOffset;
        [Range(-90, 90)]
        [FormerlySerializedAs("verticalFrustumOffset")]
        [HideInInspector, Obsolete("Use Holoplay.CameraData instead."), SerializeField] private float obsolete_VerticalFrustumOffset;
        [FormerlySerializedAs("useFrustumTarget")]
        [HideInInspector, Obsolete("Use Holoplay.CameraData instead."), SerializeField] private bool obsolete_UseFrustumTarget;
        [FormerlySerializedAs("frustumTarget")]
        [HideInInspector, Obsolete("Use Holoplay.CameraData instead."), SerializeField] private Transform obsolete_FrustumTarget;

        [FormerlySerializedAs("viewInterpolation")]
        [HideInInspector, Obsolete("Use Holoplay.Optimization instead."), SerializeField] private ViewInterpolationType obsolete_ViewInterpolation = ViewInterpolationType.None;
        [FormerlySerializedAs("reduceFlicker")]
        [HideInInspector, Obsolete("Use Holoplay.Optimization instead."), SerializeField] private bool obsolete_ReduceFlicker;
        [FormerlySerializedAs("fillGaps")]
        [HideInInspector, Obsolete("Use Holoplay.Optimization instead."), SerializeField] private bool obsolete_FillGaps;
        [FormerlySerializedAs("blendViews")]
        [HideInInspector, Obsolete("Use Holoplay.Optimization instead."), SerializeField] private bool obsolete_BlendViews;
        ...
        [HideInInspector, Obsolete("Use Holoplay.Events instead."), SerializeField] private HoloplayLoadEvent obsolete_OnHoloplayReady;
        ...
        [HideInInspector, Obsolete("Use Holoplay.Events instead."), SerializeField] private HoloplayViewRenderEvent obsolete_OnViewRender;
        ...
        [HideInInspector, Obsolete("Use Holoplay.Debugging instead."), SerializeField] private bool obsolete_ShowAllObjects = false;
        ...
        //NOTE: While we migrate serialization layout, we'll be using this...
        public void OnBeforeSerialize() {
            ...
            if (previous < Holoplay.Version) {
                ...
                if (IsUpdatingBetween(previous, Holoplay.Version, new Version(1, 5, 0))) {
                    Debug.Log(this + " transferring to new serialization layout for " + Holoplay.Version + "!");
#pragma warning disable 0618
                    cameraData.Size = obsolete_Size;
                    cameraData.NearClipFactor = obsolete_NearClipFactor;
                    cameraData.FarClipFactor = obsolete_FarClipFactor;
                    cameraData.ScaleFollowsSize = obsolete_ScaleFollowsSize;
                    cameraData.ClearFlags = obsolete_ClearFlags;
                    cameraData.BackgroundColor = obsolete_Background;
                    cameraData.CullingMask = obsolete_CullingMask;
                    cameraData.FieldOfView = obsolete_FieldOfView;
                    cameraData.Depth = obsolete_Depth;
                    cameraData.RenderingPath = obsolete_RenderingPath;
                    cameraData.UseOcclusionCulling = obsolete_OcclusionCulling;
                    cameraData.AllowHDR = obsolete_AllowHDR;
                    cameraData.AllowMSAA = obsolete_AllowMSAA;
#if UNITY_2017_3_OR_NEWER
                    cameraData.AllowDynamicResolution = obsolete_AllowDynamicResolution;
#endif
                    cameraData.UseFrustumTarget = obsolete_UseFrustumTarget;
                    cameraData.FrustumTarget = obsolete_FrustumTarget;
                    cameraData.ViewconeModifier = obsolete_ViewconeModifier;
                    cameraData.CenterOffset = obsolete_CenterOffset;
                    cameraData.HorizontalFrustumOffset = obsolete_HorizontalFrustumOffset;
                    cameraData.VerticalFrustumOffset = obsolete_VerticalFrustumOffset;

                    gizmos.DrawHandles = obsolete_DrawHandles;
                    gizmos.FrustumColor = obsolete_FrustumColor;
                    gizmos.HandleColor = obsolete_HandleColor;

                    optimization.ViewInterpolation = obsolete_ViewInterpolation;
                    optimization.ReduceFlicker = obsolete_ReduceFlicker;
                    optimization.FillGaps = obsolete_FillGaps;
                    optimization.BlendViews = obsolete_BlendViews;

                    events.OnHoloplayReady = obsolete_OnHoloplayReady;
                    events.OnViewRender = obsolete_OnViewRender;

                    debugging.ShowAllObjects = obsolete_ShowAllObjects;
#pragma warning restore 0618
        ...
        private void LateUpdate() {
            if (RenderPipelineUtil.IsHDRP) {
                Debug.Log("LateUpdate Rendering...");
                RenderQuilt();
            }
        ...
        public void ResetCamera() {
            ...
            cameraData.SetCamera(singleViewCamera, transform, Calibration.aspect, cameraDistance);
