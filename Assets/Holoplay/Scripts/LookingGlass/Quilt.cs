...
namespace LookingGlass {
    public static class Quilt {
        ...
        public struct Settings {
            ...
            //NOTE: SINGLE VIEW's aspect ratio!
            [Tooltip("To use the default aspect for the current Looking Glass, set this value to -1.")]
            public float aspect;
            ...
            public float CalculatedSingleViewAspect {
                get {
                    if (aspect < 0)
